angular.module('apf.appModule').run(['$templateCache', function($templateCache) {
  ...
  $templateCache.put('src/contribute/contribute-deployment.html',
    "<div ng-controller=\"DeploymentController\"><div pf-wizard-substep=\"\" step-title=\"Submit Draft\" step-id=\"review-progress\" step-priority=\"1\" next-enabled=\"true\" prev-enabled=\"false\" ok-to-nav-away=\"true\" wz-disabled=\"false\" on-show=\"onShow\"><div class=\"wizard-pf-contents\" ng-controller=\"DeploymentController\"><div class=\"wizard-pf-process blank-slate-pf\" ng-if=\"!deploymentComplete\"><div class=\"spinner spinner-lg blank-slate-pf-icon\"></div><h5 class=\"blank-slate-pf-main-action\" id=\"example_source_deployment-in-progress\">Deployment in progress</h5><p class=\"blank-slate-pf-secondary-action\">Lorem ipsum dolor sit amet, porta at suspendisse ac, ut wisi vivamus, lorem sociosqu eget nunc amet.</p></div><div class=\"wizard-pf-complete blank-slate-pf\" ng-if=\"deploymentComplete\"><div class=\"wizard-pf-success-icon\"><span class=\"glyphicon glyphicon-ok-circle\"></span></div><h5 class=\"blank-slate-pf-main-action\" id=\"example_source_deployment-was-successful\">Deployment was successful</h5><p class=\"blank-slate-pf-secondary-action\">Lorem ipsum dolor sit amet, porta at suspendisse ac, ut wisi vivamus, lorem sociosqu eget nunc amet.</p><button type=\"button\" class=\"btn btn-lg btn-primary\">View Deployment</button></div></div></div></div>"
  );
  ...
  $templateCache.put('src/contribute/contribute-review-second.html',
    "<div ng-controller=\"DetailsReviewController\"><form class=\"form\"><div class=\"wizard-pf-review-item\"><span class=\"wizard-pf-review-item-label\">Lorem:</span> <span class=\"wizard-pf-review-item-value\">{{data.lorem}}</span></div><div class=\"wizard-pf-review-item\"><span class=\"wizard-pf-review-item-label\">Ipsum:</span> <span class=\"wizard-pf-review-item-value\">{{data.ipsum}}</span></div></form></div>"
  );
  ...
  $templateCache.put('src/contribute/contribute-second-step.html',
    "<div ng-controller=\"SecondStepController\"><div pf-wizard-step=\"\" focus-selectors=\"focusSelectors\" step-title=\"Documents\" next-tooltip=\"secondStepNextTooltip\" prev-tooltip=\"secondStepPrevTooltip\" substeps=\"false\" step-id=\"configuration\" step-priority=\"1\" show-review=\"true\" review-template=\"src/contribute/contribute-review-second.html\"><form class=\"form-horizontal\"><h5 id=\"example_source_wizards-should-make-use-of-substeps-consistently-throughout-this-is-an-example-only\">Wizards should make use of substeps consistently throughout (either using them or not using them). This is an example only.</h5><div pf-form-group=\"\" pf-label=\"Lorem\" pf-label-class=\"col-sm-3 col-md-2\" pf-input-class=\"col-sm-9 col-md-10\"><input id=\"step-two-new-lorem\" name=\"lorem\" ng-model=\"data.lorem\" type=\"text\"></div><div pf-form-group=\"\" pf-label=\"Ipsum\" pf-label-class=\"col-sm-3 col-md-2\" pf-input-class=\"col-sm-9 col-md-10\"><input id=\"step-two-new-ipsum\" name=\"ipsum\" ng-model=\"data.ipsum\" type=\"text\"></div></form></div></div>"
  );
  ...
  $templateCache.put('src/contribute/contribute-wizard.html',
    "<div pf-wizard=\"\" wizard-title=\"Wizard Title\" wizard-ready=\"wizardReady\" on-finish=\"finishedWizard()\" on-cancel=\"cancelDeploymentWizard()\" next-title=\"nextButtonTitle\" next-callback=\"nextCallback\" back-callback=\"backCallback\" wizard-done=\"deployComplete || deployInProgress\" sidebar-class=\"example-wizard-sidebar\" step-class=\"example-wizard-step\" loading-secondary-information=\"secondaryLoadInformation\" content-height=\"450\" on-step-changed=\"stepChanged(step, index)\"><div pf-wizard-step=\"\" step-title=\"Details\" next-tooltip=\"firstStepNextTooltip\" prev-tooltip=\"firstStepPrevTooltip\" substeps=\"true\" step-id=\"details\" step-priority=\"0\" show-review=\"true\" show-review-details=\"true\"><div ng-include=\"'src/contribute/contribute-detail.html'\"></div><div pf-wizard-substep=\"\" step-title=\"Description\" next-enabled=\"true\" step-id=\"details-extra\" step-priority=\"1\" show-review=\"true\" show-review-details=\"true\" review-template=\"src/contribute/contribute-review-second.html\"><form class=\"form-horizontal\"><div pf-form-group=\"\" pf-label=\"Lorem\" pf-label-class=\"col-sm-3 col-md-2\" pf-input-class=\"col-sm-9 col-md-10\" required><input id=\"new-lorem\" name=\"lorem\" ng-model=\"data.lorem\" type=\"text\" required></div><div pf-form-group=\"\" pf-label=\"Ipsum\" pf-label-class=\"col-sm-3 col-md-2\" pf-input-class=\"col-sm-9 col-md-10\"><input id=\"new-ipsum\" name=\"ipsum\" ng-model=\"data.ipsum\" type=\"text\"></div></form></div><div pf-wizard-substep=\"\" step-title=\"Detail Explanation\" next-enabled=\"true\" step-id=\"details-extra\" step-priority=\"1\" show-review=\"true\" show-review-details=\"true\" review-template=\"src/contribute/contribute-review-second.html\"><form class=\"form-horizontal\"><div pf-form-group=\"\" pf-label=\"Lorem\" pf-label-class=\"col-sm-3 col-md-2\" pf-input-class=\"col-sm-9 col-md-10\" required><input id=\"new-lorem\" name=\"lorem\" ng-model=\"data.lorem\" type=\"text\" required></div><div pf-form-group=\"\" pf-label=\"Ipsum\" pf-label-class=\"col-sm-3 col-md-2\" pf-input-class=\"col-sm-9 col-md-10\"><input id=\"new-ipsum\" name=\"ipsum\" ng-model=\"data.ipsum\" type=\"text\"></div></form></div></div><div ng-include=\"'src/contribute/contribute-second-step.html'\"></div><div pf-wizard-step=\"\" step-title=\"Review\" next-tooltip=\"reviewStepNextTooltip\" prev-tooltip=\"reviewStepPrevTooltip\" substeps=\"true\" step-id=\"review\" step-priority=\"2\"><div ng-include=\"'src/contribute/contribute-summary.html'\"></div><div ng-include=\"'src/contribute/contribute-deployment.html'\"></div></div></div>"
  );
